...
func TestConversationControlPlaneImmutabilityOnPostgres(t *testing.T) {
	...
	seeds := []struct {
		...
		{`INSERT INTO workflow_definition_versions (id, definition_id, version, schema_version, content, content_hash, validation_report, published, created_by) VALUES ($1, $2, 1, 2, '{}'::jsonb, 'sha256:test', '{"valid":true}'::jsonb, true, $3)`, []any{definitionVersionID, definitionID, userID}},
		...
		{`INSERT INTO workflow_intent_proposals (id, project_id, conversation_id, trigger_message_id, assistant_message_id, kind, suggested_definition_version_id, scope, source_refs, manifest_intent, workbench_instruction, origin, proposed_by) VALUES ($1, $2, $3, $4, $5, 'start_workflow', $6, '{}'::jsonb, '[{"artifactId":"a","revisionId":"r","contentHash":"sha256:test"}]'::jsonb, '{"mode":"use_existing"}'::jsonb, '{"objective":"Build"}'::jsonb, 'submitted', $7)`, []any{proposalID, projectID, conversationID, userMessageID, assistantMessageID, definitionVersionID, userID}},
		...
		{`INSERT INTO conversation_commands (id, project_id, conversation_id, proposal_id, kind, payload, accepted_by) VALUES ($1, $2, $3, $4, 'start_workflow', '{"definitionVersionId":"test"}'::jsonb, $5)`, []any{commandID, projectID, conversationID, proposalID, userID}},
	}
